	  ...
	  <div class="col-sm-3">
        <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="1100ms">
          ...
          <div class="social-icons">
            <ul>
              <?php if(!empty($a['web'])):?>
              	     <li title="homepage" class="contact-person"><a href="<?php echo $a['web'] ?>" target="_blank"><i class="fa fa-home"></i></a></li>
              <?php endif;?>    
              <?php if(!empty($a['facebook'])):?>
              	     <li title="facebook" class="contact-person"><a href="<?php echo $a['facebook'] ?>" target="_blank"><i class="fa fa-facebook"></i></a></li>
              <?php endif;?>
              <?php if(!empty($a['twitter'])):?>
              	     <li title="twitter" class="contact-person"><a href="<?php echo $a['twitter'] ?>" target="_blank"><i class="fa fa-twitter"></i></a></li>
              <?php endif;?>
              <?php if(!empty($a['github'])):?>
              	     <li title="github" class="contact-person"><a href="<?php echo $a['github'] ?>" target="_blank"><i class="fa fa-github"></i></a></li>
              <?php endif;?>
